...
export const WeeklyFeatured: FC<PropsWithChildren<unknown>> = () => {
  return (
        ...
        <div className='slider_wf'>
          <div className='video_item'>
            <div className='thumbnail'>
              <Image src='/img/main/1.jpg' alt='' width={100} height={100} />
              <time>16:55</time>
            </div>
          ...
          <div className='video_item'>
            <div className='thumbnail'>
              <Image src='/img/main/2.jpg' alt='' width={100} height={100} />
              <time>07:23</time>
            </div>
          ...
          <div className='video_item'>
            <div className='thumbnail'>
              <Image src='/img/main/3.jpg' alt='' width={100} height={100} />
              <time>16:55</time>
            </div>
            <div className='author'>Micheal Adams</div>
            <div className='name'>Day in my life: Summer ...</div>
